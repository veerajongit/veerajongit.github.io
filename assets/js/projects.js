const projects = [{
    ...
    technology: 'Laravel, PHP, MySQL, jQuery',
    platform: 'Desktop, Tablet, Mobile',
    about: 'GSB Seva Mandal is a non profit organization registered in India under Bombay Public Trust Act, 1950 in the year 1951.',
    img: 'gsbsevamandal.min.jpg',
    url: ['http://gsbsevamandal.org']
}, {
    name: 'The GA Group',
    ...
    name: 'Prithu Homes',
    technology: 'PHP, MySQL, Bash Scripting',
    platform: 'Desktop, Tablet, Mobile',
    about: 'Pricing calculator & PDF template emailing for Prithu Homes',
    img: 'prithu.min.png',
    url: ['http://www.prithu.in']
}, {
    name: 'SIIEXPO',
    technology: 'Bootstrap, PHP, MySQL',
    platform: 'Desktop, Tablet, Mobile',
    about: 'Singapore International Indian EXPO is the largest shopping and entertainment extravaganza in Singapore.',
    img: 'siiexpo.min.jpg',
    url: ['http://www.siiexpo.com']
}, {
    name: 'DEIDEAZ',
    technology: 'Bootstrap, PHP, MySQL',
    platform: 'Desktop, Tablet, Mobile',
    ...
    name: 'GSB DB Navratri',
    technology: 'PHP, MySQL, Ionic',
    platform: 'Mobile',
    about: 'Gaud Saraswat Brahmin Community, Dahisar-Borivali Branch\'s Seva collection app for GSBDB Navratri Utsav',
    img: 'gsbdb.min.png',
    url: ['https://play.google.com/store/apps/details?id=com.ionicframework.dbnav2286156']
}, {
    name: '3iosales',
    technology: 'PHP, MySQL, Ionic',
    platform: 'Desktop, Tablet, Mobile',
    ...
    url: [
        ...
        'https://play.google.com/store/apps/details?id=com.iosales.app'
    ]
}, {
    name: 'Hello Punjabi',
    technology: 'PHP, MySQL, Ionic',
    ...
    url: [
        ...
        'https://play.google.com/store/apps/details?id=com.management.facility'
    ]
}, {
    name: 'Hospital Management System',
    technology: 'PHP, MySQL, Bootstrap, jQuery',
    platform: 'Desktop, Tablet',
    about: 'A full fledged cash/cheque collection app. Also helps in monitoring and analysis of the patients and their medical history.',
    img: 'hospital.min.png',
    url: []
}, {
